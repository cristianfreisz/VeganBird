...
public class Juego extends InterfaceJuego
{
	...
	public void tick()
	{
		...
		if(estado_juego) {
			...
			this.entorno.cambiarFont("BOLD",18,Color.BLACK);
			...
			this.entorno.escribirTexto("TIEMPO: "+Integer.toString(this.tiempoJuego)+" SEG", 625, 50);
			this.contadorTick++;
			tiempo();
